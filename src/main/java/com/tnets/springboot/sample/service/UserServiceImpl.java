...
import com.tnets.springboot.sample.repositories.RoleRepository;
import com.tnets.springboot.sample.repositories.UserRepository;
...
public class UserServiceImpl implements UserService {
	...
	public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
		...
		System.out.println("Going to check user " + email);
